...
class _renteeToolDetailsState extends State<RenteeToolDetails> {
              ...
              children: [
                TableRow(children: [
                  ...
                  Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text(widget.tool.toolDescription.toString(),
  ...
  launchWhatsApp() async{
    var whatsapp = widget.renter.phone;
    var whatsapptool = widget.tool.toolName;
    final link = WhatsAppUnilink(
      phoneNumber: '+6$whatsapp',
      text: "Hey! I'm inquiring about the tool $whatsapptool"
    );
   // await launchUrl();
  }
